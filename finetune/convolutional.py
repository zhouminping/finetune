...
from finetune.transformer import dropout, embed, embed_no_timing, block, attn, norm, conv1d
from finetune.transformer import block as transformer_block
...
def gated_linear_unit(X, kernel_width, layer_name, use_fp16, training, backwards=False, mask=None):
    ...
    with tf.variable_scope(layer_name, reuse=backwards):
        ...
        out = norm(conv_gate, "norm2", fp16=use_fp16, debug=False) + X
